...
public class SolutionDecoder {
    ...
    private static final int BLOCKS_PER_DAY = ProblemInstance.SLOTS_PER_CLASSROOM_PER_DAY * ProblemInstance.BLOCKS_PER_SLOT;
    ...
    public void printSummary(IntegerSolution solution) {
        ...
        System.out.println("Salones unicos utilizados: " + allUsedClassrooms.size() + " de " + instance.getClassrooms().size());
